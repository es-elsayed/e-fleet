...
return [
    ...
    'extensions' => 'يجب أن يكون حقل :attribute ملفًا بنوع أحد الامتدادات التالية: :values.',
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لوناً سداسي عشريًا صالحًا.',
    ...
    'lt' => [
        ...
        'string' => 'يجب أن يكون طول نص :attribute أصغر من :value حرفًا.',
    ],
    'lte' => [
        ...
        'string' => 'يجب أن يكون طول نص :attribute أصغر من أو يساوي :value حرفًا.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة :attribute قد ظهرت في تسريب بيانات. الرجاء اختيار :attribute مختلفًا.',
    ],
